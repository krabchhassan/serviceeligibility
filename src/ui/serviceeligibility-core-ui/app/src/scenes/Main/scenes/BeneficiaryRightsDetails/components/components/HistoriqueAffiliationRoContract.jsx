...
class HistoriqueAffiliationROContract extends Component {
    getColumns() {
        return [
            this.generateCommonColumn('nirCode', 100),
            this.generateCommonColumn('nirCle', 100),
            this.generateCommonColumn('rattachementROCodeRegime', 100),
            this.generateCommonColumn('rattachementROCodeCaisse', 100),
            this.generateCommonColumn('rattachementROCodeCentre', 100),
    ...
    render() {
        ...
        const data = historique.map((item) => ({
            ...item,
            nirCode: businessUtils.formatRO(item.nir?.code),
            nirCle: item.nir?.cle,
...
// Add prop types
HistoriqueAffiliationROContract.propTypes = propTypes;
// Add default props
HistoriqueAffiliationROContract.defaultProps = defaultProps;

/* ************************************* */
/* ********       EXPORTS       ******** */
/* ************************************* */
export default HistoriqueAffiliationROContract;
