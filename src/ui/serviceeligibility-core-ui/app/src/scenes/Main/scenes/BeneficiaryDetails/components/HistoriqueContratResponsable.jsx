...
class HistoriqueContratResponsable extends Component {
    getColumns() {
    ...
    generateCommonColumn(key, width) {
        const { t } = this.props;
        return {
            Header: StringUtils.splitIntoDivs(t(`historiqueContratResponsable.${key}`), false),
            accessor: key,
            id: key,
            width,
            disableSortBy: true,
...
// Add prop types
HistoriqueContratResponsable.propTypes = propTypes;
// Add default props
HistoriqueContratResponsable.defaultProps = defaultProps;

/* ************************************* */
/* ********       EXPORTS       ******** */
/* ************************************* */
export default HistoriqueContratResponsable;
