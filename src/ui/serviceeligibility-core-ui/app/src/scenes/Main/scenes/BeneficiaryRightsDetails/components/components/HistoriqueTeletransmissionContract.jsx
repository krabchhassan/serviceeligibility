...
class HistoriqueTeletransmissionContract extends Component {
    getColumns() {
        return [
        ...
        return (
            <Row>
                <Col className="ml-3 pl-3 mr-3 mb-1">
                    <Row>
                        <CgdTable
                            id="teletransmissionHistoryTable"
                            data={data}
...
// Add prop types
HistoriqueTeletransmissionContract.propTypes = propTypes;
// Add default props
HistoriqueTeletransmissionContract.defaultProps = defaultProps;

/* ************************************* */
/* ********       EXPORTS       ******** */
/* ************************************* */
export default HistoriqueTeletransmissionContract;
