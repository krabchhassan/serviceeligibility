...
/**
 * &lt;p&gt;Classe Java pour InfoDecompte complex type.
 *
 * <p>&lt;p&gt;Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <p>&lt;pre&gt; &amp;lt;complexType name="InfoDecompte"&amp;gt; &amp;lt;complexContent&amp;gt;
 * &amp;lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&amp;gt;
 * &amp;lt;sequence&amp;gt; &amp;lt;element name="REF_INTERNE_OS_PRINCIPAL"
 * type="{http://www.almerys.com/NormeV3}string-1-30"/&amp;gt; &amp;lt;element
 * name="REF_INTERNE_OS_AYANT_DROIT" type="{http://www.almerys.com/NormeV3}string-1-30"
 * maxOccurs="unbounded" minOccurs="0"/&amp;gt; &amp;lt;element name="DATE_DEBUT_VALIDITE"
...
@XmlType(
    name = "InfoDecompte",
    propOrder = {
      "refinterneosprincipal",
      "refinterneosayantdroits",
      "datedebutvalidite",
      "datefinvalidite",
      "datedebutsuspension",
      "datefinsuspension",
...
public class InfoDecompte implements Serializable {

  private static final long serialVersionUID = -1L;

  @XmlElement(name = "REF_INTERNE_OS_PRINCIPAL", required = true)
  protected String refinterneosprincipal;

  @XmlElement(name = "REF_INTERNE_OS_AYANT_DROIT")
  protected List<String> refinterneosayantdroits;
  ...
  /**
   * Obtient la valeur de la propriété refinterneosprincipal.
   *
   * @return possible object is {@link String }
   */
  public String getREFINTERNEOSPRINCIPAL() {
    return refinterneosprincipal;
  }

  /**
   * Définit la valeur de la propriété refinterneosprincipal.
   *
   * @param value allowed object is {@link String }
   */
  public void setREFINTERNEOSPRINCIPAL(String value) {
    this.refinterneosprincipal = value;
  }

  /**
   * Gets the value of the refinterneosayantdroits property.
   *
   ...
   * refinterneosayantdroits property.
   *
   * <p>&lt;p&gt; For example, to add a new item, do as follows: &lt;pre&gt;
   * getREFINTERNEOSAYANTDROITS().add(newItem); &lt;/pre&gt;
   *
   * <p>&lt;p&gt; Objects of the following type(s) are allowed in the list {@link String }
   */
  public List<String> getREFINTERNEOSAYANTDROITS() {
    if (refinterneosayantdroits == null) {
      refinterneosayantdroits = new ArrayList<String>();
    }
    return this.refinterneosayantdroits;
  }
