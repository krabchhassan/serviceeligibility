...
/**
 * &lt;p&gt;Classe Java pour infoBenef complex type.
 *
 * <p>&lt;p&gt;Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <p>&lt;pre&gt; &amp;lt;complexType name="infoBenef"&amp;gt; &amp;lt;complexContent&amp;gt;
 ...
 * type="{http://www.almerys.com/NormeV3}infoRO" maxOccurs="3" minOccurs="0"/&amp;gt;
 * &amp;lt;element name="CONTRAT_RESPONSABLE" type="{http://www.w3.org/2001/XMLSchema}boolean"
 ...
 * &amp;lt;element name="DETAIL_CARTE" type="{http://www.almerys.com/NormeV3}infoDetailCarte"
 * minOccurs="0"/&amp;gt; &amp;lt;element name="RESEAU"
 * type="{http://www.almerys.com/NormeV3}infoReseau" maxOccurs="unbounded" minOccurs="0"/&amp;gt;
...
public class InfoBenef implements Serializable {
  ...
  @XmlElement(name = "DETAIL_CARTE")
  protected InfoDetailCarte detailcarte;

  @XmlElement(name = "RESEAU")
  protected List<InfoReseau> reseaus;
  ...
  /**
   * Gets the value of the ros property.
   *
   ...
   * object. This is why there is not a &lt;CODE&gt;set&lt;/CODE&gt; method for the ros property.
   *
   * <p>&lt;p&gt; For example, to add a new item, do as follows: &lt;pre&gt; getROS().add(newItem);
   * &lt;/pre&gt;
   *
   * <p>&lt;p&gt; Objects of the following type(s) are allowed in the list {@link InfoRO }
   */
  public List<InfoRO> getROS() {
    if (ros == null) {
      ros = new ArrayList<InfoRO>();
    }
    return this.ros;
  }
  ...
  /**
   * Obtient la valeur de la propriété detailcarte.
   *
   * @return possible object is {@link InfoDetailCarte }
   */
  public InfoDetailCarte getDETAILCARTE() {
    return detailcarte;
  }

  /**
   * Définit la valeur de la propriété detailcarte.
   *
   * @param value allowed object is {@link InfoDetailCarte }
   */
  public void setDETAILCARTE(InfoDetailCarte value) {
    this.detailcarte = value;
  }

  /**
   * Gets the value of the reseaus property.
   *
   * <p>&lt;p&gt; This accessor method returns a reference to the live list, not a snapshot.
   * Therefore any modification you make to the returned list will be present inside the JAXB
   * object. This is why there is not a &lt;CODE&gt;set&lt;/CODE&gt; method for the reseaus
   * property.
   *
   * <p>&lt;p&gt; For example, to add a new item, do as follows: &lt;pre&gt;
   * getRESEAUS().add(newItem); &lt;/pre&gt;
   *
   * <p>&lt;p&gt; Objects of the following type(s) are allowed in the list {@link InfoReseau }
   */
  public List<InfoReseau> getRESEAUS() {
    if (reseaus == null) {
      reseaus = new ArrayList<InfoReseau>();
    }
    return this.reseaus;
  }
}
