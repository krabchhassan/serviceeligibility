package com.cegedim.next.serviceeligibility.core.kafkabenef.serviceprestation;
...
public class ProducerBenef {
  ...
  public void send(final PersonAICommun message, String source)
    ...
    try {
      ...
      String topicBenefAi =
          beyondPropertiesService.getPropertyOrThrowError(KAFKA_TOPIC_BDD_BENEFAI);
      log.info("sending to the topic {} with key {}", topicBenefAi, key);
