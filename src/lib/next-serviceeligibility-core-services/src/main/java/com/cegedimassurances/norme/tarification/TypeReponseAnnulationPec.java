...
/**
 * Classe Java pour type_reponse_annulation_pec complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="type_reponse_annulation_pec"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(
    name = "type_reponse_annulation_pec",
    propOrder = {"idPrescription", "numeroAccreditation"})
public class TypeReponseAnnulationPec implements Serializable, Cloneable, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof TypeReponseAnnulationPec) {
      final TypeReponseAnnulationPec copy = ((TypeReponseAnnulationPec) draftCopy);
  ...
  public Object createNewInstance() {
    return new TypeReponseAnnulationPec();
  }
}
