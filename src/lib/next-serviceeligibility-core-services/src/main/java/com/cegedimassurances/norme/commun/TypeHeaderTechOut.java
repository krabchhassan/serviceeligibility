 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="type_transaction" minOccurs="0"&gt;
 *           &lt;simpleType&gt;
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string"&gt;
 *               &lt;length value="1"/&gt;
 *               &lt;enumeration value=" "/&gt;
...
public class TypeHeaderTechOut implements Serializable, Cloneable, CopyTo {
  ...
  @XmlElement(name = "type_transaction")
  @Size(min = 1, max = 1)
  @Pattern.List({@Pattern(regexp = " "), @Pattern(regexp = "0"), @Pattern(regexp = "1")})
  ...
  /**
   * Obtient la valeur de la propriété typeTransaction.
   *
   * @return possible object is {@link String }
   */
  ...
  /**
   * Définit la valeur de la propriété typeTransaction.
   *
   * @param value allowed object is {@link String }
   */
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof TypeHeaderTechOut) {
      ...
      if (this.typeTransaction != null) {
        String sourceTypeTransaction;
        sourceTypeTransaction = this.getTypeTransaction();
        String copyTypeTransaction =
            ((String)
                strategy.copy(
                    LocatorUtils.property(locator, "typeTransaction", sourceTypeTransaction),
                    sourceTypeTransaction));
        copy.setTypeTransaction(copyTypeTransaction);
      } else {
        copy.typeTransaction = null;
      }
