 ...
 *       &lt;sequence&gt;
 *         &lt;element name="headerTech" type="{http://norme.cegedimassurances.com/commun}type_header_tech_out"/&gt;
 *         &lt;element name="headerFonc" type="{http://norme.cegedimassurances.com/commun}type_header_fonctionnel_out" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TypeHeaderOut implements Serializable, Cloneable, CopyTo {
  ...
  @NotNull
  @Valid
  protected TypeHeaderTechOut headerTech;

  @Valid protected TypeHeaderFonctionnelOut headerFonc;
   ...
   */
  public TypeHeaderTechOut getHeaderTech() {
    return headerTech;
  }
   ...
   */
  public void setHeaderTech(TypeHeaderTechOut value) {
   ...
   */
  public TypeHeaderFonctionnelOut getHeaderFonc() {
    return headerFonc;
  }
   ...
   */
  public void setHeaderFonc(TypeHeaderFonctionnelOut value) {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof TypeHeaderOut) {
      ...
      if (this.headerTech != null) {
        TypeHeaderTechOut sourceHeaderTech;
        sourceHeaderTech = this.getHeaderTech();
        TypeHeaderTechOut copyHeaderTech =
            ((TypeHeaderTechOut)
                strategy.copy(
      ...
      if (this.headerFonc != null) {
        TypeHeaderFonctionnelOut sourceHeaderFonc;
        sourceHeaderFonc = this.getHeaderFonc();
        TypeHeaderFonctionnelOut copyHeaderFonc =
