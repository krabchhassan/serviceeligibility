...
/**
 * Classe Java pour type_reponse_justification_calcul complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="type_reponse_justification_calcul"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(
    name = "type_reponse_justification_calcul",
    propOrder = {"numeroAccreditation"})
public class TypeReponseJustificationCalcul implements Serializable, Cloneable, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof TypeReponseJustificationCalcul) {
      final TypeReponseJustificationCalcul copy = ((TypeReponseJustificationCalcul) draftCopy);
