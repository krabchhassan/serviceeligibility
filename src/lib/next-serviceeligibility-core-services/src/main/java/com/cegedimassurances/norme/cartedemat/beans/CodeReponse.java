...
/**
 * Classe Java pour code_reponse complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="code_reponse"&gt;
 *   &lt;complexContent&gt;
...
public class CodeReponse implements Serializable, Cloneable, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof CodeReponse) {
      final CodeReponse copy = ((CodeReponse) draftCopy);
      if (this.code != null) {
        String sourceCode;
