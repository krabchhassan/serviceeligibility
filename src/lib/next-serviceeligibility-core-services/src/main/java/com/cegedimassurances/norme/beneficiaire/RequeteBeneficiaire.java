...
/**
 * Classe Java pour requete_beneficiaire complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="requete_beneficiaire"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(
    ...
    propOrder = {"headerIn", "beneficiaire", "amc", "dates"})
public class RequeteBeneficiaire implements Serializable, Cloneable, RequeteWsFsiq, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof RequeteBeneficiaire) {
      final RequeteBeneficiaire copy = ((RequeteBeneficiaire) draftCopy);
  ...
  public Object createNewInstance() {
    return new RequeteBeneficiaire();
  }
}
