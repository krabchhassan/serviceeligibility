...
@XmlRootElement(name = "carteDematerialiseeRequest")
public class CarteDematerialiseeRequest implements Serializable, Cloneable, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof CarteDematerialiseeRequest) {
      final CarteDematerialiseeRequest copy = ((CarteDematerialiseeRequest) draftCopy);
  ...
  public Object createNewInstance() {
    return new CarteDematerialiseeRequest();
  }
