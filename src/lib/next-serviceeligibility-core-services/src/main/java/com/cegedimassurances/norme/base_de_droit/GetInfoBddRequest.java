...
/**
 * Classe Java pour get_info_bdd_request complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="get_info_bdd_request"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="info_bdd" type="{http://norme.cegedimassurances.com/base_de_droit}type_info_bdd"/&gt;
...
@XmlType(
    name = "get_info_bdd_request",
    propOrder = {"headerIn", "beneficiaire", "amc", "infoBdd", "dates"})
public class GetInfoBddRequest implements Serializable, Cloneable, CopyTo {

  @XmlElement(name = "header_in", required = true, nillable = true)
  @NotNull
  @Valid
  ...
  @XmlElement(name = "info_bdd", required = true)
  @NotNull
  @Valid
  protected TypeInfoBdd infoBdd;
  ...
  /**
   * Obtient la valeur de la propriété infoBdd.
   *
   * @return possible object is {@link TypeInfoBdd }
   */
  public TypeInfoBdd getInfoBdd() {
    return infoBdd;
  }

  /**
   * Définit la valeur de la propriété infoBdd.
   *
   * @param value allowed object is {@link TypeInfoBdd }
   */
  public void setInfoBdd(TypeInfoBdd value) {
    this.infoBdd = value;
  }
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof GetInfoBddRequest) {
      final GetInfoBddRequest copy = ((GetInfoBddRequest) draftCopy);
      ...
      if (this.infoBdd != null) {
        TypeInfoBdd sourceInfoBdd;
        sourceInfoBdd = this.getInfoBdd();
        TypeInfoBdd copyInfoBdd =
            ((TypeInfoBdd)
                strategy.copy(
                    LocatorUtils.property(locator, "infoBdd", sourceInfoBdd), sourceInfoBdd));
        copy.setInfoBdd(copyInfoBdd);
      } else {
        copy.infoBdd = null;
      }
      if (this.dates != null) {
