...
/**
 * Classe Java pour type_requete_annulation_pec complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="type_requete_annulation_pec"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="total_prescription" minOccurs="0"&gt;
 *           &lt;simpleType&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="total_pec_prescription" minOccurs="0"&gt;
 *           &lt;simpleType&gt;
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}decimal"&gt;
 *               &lt;totalDigits value="7"/&gt;
 *               &lt;fractionDigits value="2"/&gt;
 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="total_rac_prescription" minOccurs="0"&gt;
 *           &lt;simpleType&gt;
 *             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}decimal"&gt;
 *               &lt;totalDigits value="7"/&gt;
 *               &lt;fractionDigits value="2"/&gt;
...
@XmlType(
    name = "type_requete_annulation_pec",
    propOrder = {
      "idPrescription",
      "numeroAccreditation",
      "totalPrescription",
...
public class TypeRequeteAnnulationPec implements Serializable, Cloneable, CopyTo {
  ...
  @XmlElement(name = "total_prescription")
  @Digits(integer = 7, fraction = 2)
  protected BigDecimal totalPrescription;

  @XmlElement(name = "total_pec_prescription")
  @Digits(integer = 7, fraction = 2)
  protected BigDecimal totalPecPrescription;

  @XmlElement(name = "total_rac_prescription")
  @Digits(integer = 7, fraction = 2)
  ...
  /**
   * Obtient la valeur de la propriété totalPrescription.
   *
   * @return possible object is {@link BigDecimal }
   */
  public BigDecimal getTotalPrescription() {
    return totalPrescription;
  }

  /**
   * Définit la valeur de la propriété totalPrescription.
   *
   * @param value allowed object is {@link BigDecimal }
   */
  public void setTotalPrescription(BigDecimal value) {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof TypeRequeteAnnulationPec) {
      final TypeRequeteAnnulationPec copy = ((TypeRequeteAnnulationPec) draftCopy);
      ...
      if (this.totalPrescription != null) {
        BigDecimal sourceTotalPrescription;
        sourceTotalPrescription = this.getTotalPrescription();
        BigDecimal copyTotalPrescription =
            ((BigDecimal)
                strategy.copy(
                    LocatorUtils.property(locator, "totalPrescription", sourceTotalPrescription),
                    sourceTotalPrescription));
        copy.setTotalPrescription(copyTotalPrescription);
      } else {
        copy.totalPrescription = null;
      }
  ...
  public Object createNewInstance() {
    return new TypeRequeteAnnulationPec();
  }
}
