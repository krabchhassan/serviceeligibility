...
/**
 * Classe Java pour carteDematerialiseeResponseType complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="carteDematerialiseeResponseType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="contrat" type="{http://norme.cegedimassurances.com/carteDemat/beans}type_contrat"/&gt;
...
@XmlType(
    name = "carteDematerialiseeResponseType",
    propOrder = {"contrat", "adresseContrat", "domaines", "beneficiaires"})
public class CarteDematerialiseeResponseType implements Serializable, Cloneable, CopyTo {
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof CarteDematerialiseeResponseType) {
      final CarteDematerialiseeResponseType copy = ((CarteDematerialiseeResponseType) draftCopy);
  ...
  public Object createNewInstance() {
    return new CarteDematerialiseeResponseType();
  }
