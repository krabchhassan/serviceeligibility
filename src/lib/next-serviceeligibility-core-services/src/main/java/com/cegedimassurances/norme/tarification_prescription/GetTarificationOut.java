...
/**
 * Classe Java pour getTarification_out complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="getTarification_out"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="reponseFacture" type="{http://norme.cegedimassurances.com/tarification-prescription}type_reponse_tarification" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(
    name = "getTarification_out",
    propOrder = {"headerOut", "codeReponse", "reponseFacture"})
public class GetTarificationOut implements Serializable, Cloneable, ReponseWsFsiq, CopyTo {
  ...
  @Valid protected TypeReponseTarification reponseFacture;
  ...
  /**
   * Obtient la valeur de la propriété reponseFacture.
   *
   * @return possible object is {@link TypeReponseTarification }
   */
  public TypeReponseTarification getReponseFacture() {
    return reponseFacture;
  }

  /**
   * Définit la valeur de la propriété reponseFacture.
   *
   * @param value allowed object is {@link TypeReponseTarification }
   */
  public void setReponseFacture(TypeReponseTarification value) {
    this.reponseFacture = value;
  }
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof GetTarificationOut) {
      final GetTarificationOut copy = ((GetTarificationOut) draftCopy);
      ...
      if (this.reponseFacture != null) {
        TypeReponseTarification sourceReponseFacture;
        sourceReponseFacture = this.getReponseFacture();
        TypeReponseTarification copyReponseFacture =
            ((TypeReponseTarification)
                strategy.copy(
                    LocatorUtils.property(locator, "reponseFacture", sourceReponseFacture),
                    sourceReponseFacture));
        copy.setReponseFacture(copyReponseFacture);
      } else {
        copy.reponseFacture = null;
      }
    }
    return draftCopy;
  }
