...
/**
 * Classe Java pour reponse_carteTP complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="reponse_carteTP"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="carte" type="{http://norme.cegedimassurances.com/carte}type_carteTP" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(
    name = "reponse_carteTP",
    propOrder = {"headerOut", "codeReponse", "carte"})
public class ReponseCarteTP implements Serializable, Cloneable, ReponseWsFsiq, CopyTo {
  ...
  @Valid protected TypeCarteTP carte;
   ...
   *
   * @return possible object is {@link TypeCarteTP }
   */
  public TypeCarteTP getCarte() {
    return carte;
  }
   ...
   *
   * @param value allowed object is {@link TypeCarteTP }
   */
  public void setCarte(TypeCarteTP value) {
    this.carte = value;
  }
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof ReponseCarteTP) {
      final ReponseCarteTP copy = ((ReponseCarteTP) draftCopy);
      ...
      if (this.carte != null) {
        TypeCarteTP sourceCarte;
        sourceCarte = this.getCarte();
        TypeCarteTP copyCarte =
            ((TypeCarteTP)
                strategy.copy(LocatorUtils.property(locator, "carte", sourceCarte), sourceCarte));
        copy.setCarte(copyCarte);
      } else {
        copy.carte = null;
      }
    }
