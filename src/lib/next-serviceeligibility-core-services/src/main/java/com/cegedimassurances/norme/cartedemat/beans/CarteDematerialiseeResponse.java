 ...
 *         &lt;element name="cartes" type="{http://norme.cegedimassurances.com/carteDemat/beans}cartes" minOccurs="0"/&gt;
...
@XmlRootElement(name = "carteDematerialiseeResponse")
public class CarteDematerialiseeResponse implements Serializable, Cloneable, CopyTo {
   ...
   *
   * @return possible object is {@link Cartes }
   */
   ...
   *
   * @param value allowed object is {@link Cartes }
   */
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
    ...
    if (draftCopy instanceof CarteDematerialiseeResponse) {
      final CarteDematerialiseeResponse copy = ((CarteDematerialiseeResponse) draftCopy);
  ...
  public Object createNewInstance() {
    return new CarteDematerialiseeResponse();
  }
