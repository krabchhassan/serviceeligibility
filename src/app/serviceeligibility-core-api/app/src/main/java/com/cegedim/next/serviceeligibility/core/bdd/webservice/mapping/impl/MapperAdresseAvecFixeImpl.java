...
@Component
public class MapperAdresseAvecFixeImpl extends GenericMapperImpl<AdresseAvecFixe, AdresseDto>
    implements MapperAdresseAvecFixe {
  public MapperAdresseAvecFixeImpl(MapperTypeAdresse mapperTypeAdresse) {
    this.mapperTypeAdresse = mapperTypeAdresse;
  }

  MapperTypeAdresse mapperTypeAdresse;

  @Override
  public AdresseAvecFixe dtoToEntity(AdresseDto adresseDto) {
    AdresseAvecFixe adresse = null;
    if (adresseDto != null) {
      adresse = new AdresseAvecFixe();
