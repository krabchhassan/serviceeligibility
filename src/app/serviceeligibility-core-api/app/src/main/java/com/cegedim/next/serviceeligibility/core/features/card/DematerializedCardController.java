...
@RestController
@RequestMapping("/v3/carteDematerialisee")
public class DematerializedCardController {
  @Autowired private CardService cardService;

  @NewSpan
  @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
  @PreAuthorize(READ_PERMISSION)
  public ResponseEntity<List<CardResponse>> getCards(@RequestBody CardRequest request) {
