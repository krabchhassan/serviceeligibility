...
import com.cegedim.next.beneficiary.worker.configuration.mongo.MongoDateDeserializer;
import com.cegedim.next.beneficiary.worker.configuration.mongo.MongoObjectIdDeserializer;
