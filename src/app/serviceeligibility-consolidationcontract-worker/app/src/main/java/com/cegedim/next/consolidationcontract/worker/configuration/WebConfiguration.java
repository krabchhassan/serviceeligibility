...
import com.cegedim.next.consolidationcontract.worker.configuration.mongo.MongoDateDeserializer;
import com.cegedim.next.consolidationcontract.worker.configuration.mongo.MongoObjectIdDeserializer;
...
public class WebConfiguration implements WebMvcConfigurer {
  ...
  public void configureJacksonMapper(final ObjectMapper objectMapper) {
    ...
    objectMapper.registerModule(buildMongoModule());
  }
   ...
   */
  private SimpleModule buildMongoModule() {
    final SimpleModule simpleModule = new SimpleModule();

    simpleModule.addDeserializer(Date.class, MongoDateDeserializer.INSTANCE);
    simpleModule.addDeserializer(String.class, MongoObjectIdDeserializer.INSTANCE);
