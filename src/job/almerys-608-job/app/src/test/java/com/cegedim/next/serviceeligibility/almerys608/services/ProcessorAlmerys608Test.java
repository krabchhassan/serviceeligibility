...
@Slf4j
class ProcessorAlmerys608Test extends MockUtils {

  // TODO @Test
  void testPassant() {
    List<TmpObject2> tmpObject2List = new ArrayList<>();
    tmpObject2List.add(createTmpObject2());
    test(tmpObject2List, "generatedXml/testPassant.xml");
  }
  ...
  public TmpObject2 createTmpObject2() {
    ...
    adresse.setFixe("0505050505");
    adresse.setTelephone("0606060606");
