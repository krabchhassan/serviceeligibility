...
@Slf4j
class ProcessorAlmerys608BTest extends MockUtils {

  // TODO @Test
  void testPassantEspece() {
    List<TmpObject2> tmpObject2s = new ArrayList<>();
    tmpObject2s.add(createTmpObject2());
    test(tmpObject2s, "generatedXml/testPassantEspece.xml");
  }
  ...
  public TmpObject2 createTmpObject2() {
    ...
    contrat.setModePaiementPrestations("E");
