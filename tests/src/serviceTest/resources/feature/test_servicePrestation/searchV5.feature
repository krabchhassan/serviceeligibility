Feature: Get ServicePrestation
  ...
  @todosmokeTests @smokeTestsWithoutKafka @servicePrestation @servicePrestationV5
  Scenario: Get an existing service prestation V5 from one contract without end date on droits, and query it during the period
    ...
    When I search service prestation in version "5" for amc "929405823444", adherent "83747438", nir "1701062498046", birth date "19791006", birth rank "1" from "2020-03-01" to "2020-06-30"
  ...
  Scenario: Get an existing service prestation V5 from one contract without end date on droits, and query it during the period
    Given I drop the collection for Service Prestation
    Given I create a service prestation from a file "createServicePrestationDroitsOuvertsV5"
    When I search service prestation in version "5" for amc "929405823444", adherent "83747438", nir "1701062498046", birth date "19791006", birth rank "1" from "2020-03-01" to "2020-06-30"
    Then the servicePrestation number "0" has values
      | idDeclarant                           | 929405823444                |
      | numeroAdherent                        | 83747438                    |
      ...
      | collegeTPV5                           | Cadre                       |
      | collectiviteTPV5                      | 362 521 879 00034           |
