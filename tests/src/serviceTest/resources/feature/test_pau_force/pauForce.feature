Feature: Forçage du PAU - Feature BLUE-6133
  ...
  @smokeTests @smokeTestsWithoutKafka @pauv5 @forcePAU @release
  Scenario: Appel du PAU avant le début des contrats - Sans date de fin
    # Appel HTP
  ...
  Scenario: Appel du PAU avant le début des contrats - Avec une date de fin avant le début des contrats
    # Appel HTP
  ...
  @smokeTests @smokeTestsWithoutKafka @pauv5 @forcePAU
  Scenario: Appel du PAU avant le début des contrats - Avec une date de fin avant le début des contrats et avec le forçage d’activé
    # Appel HTP
  ...
  Scenario: Modif du 2ème contrat début période assuré au 01/01/2024 + Appel du PAU sans date de fin
    When I send a contract from file "contratV6/createServicePrest2-6133" to version "V6"
    # Appel HTP
    When I get contrat PAUV5 without endDate for 1000611111111 '19590224' 1 '2023-07-15' 0000401166 HTP for issuingCompanyCode 000ER00955
    Then we found 2 contracts
    Then the contract with indice 0 is not forced
  ...
  @smokeTests @smokeTestsWithoutKafka @pauv5 @forcePAU
  Scenario: Modif du 2ème contrat début période assuré au 01/01/2024 + Appel du PAU avec une date de fin avant le début des contrats
    When I send a contract from file "contratV6/createServicePrest2-6133" to version "V6"
    # Appel HTP
    When I get contrat PAUV5 for 1000611111111 '19590224' 1 '2023-07-15' '2023-07-18' 0000401166 HTP for issuingCompanyCode 000ER00955
    And With this request I have a contract not found exception
  ...
  @smokeTests @smokeTestsWithoutKafka @pauv5 @forcePAU @toChangeEveryYear
  Scenario: Modif du 2ème contrat début période assuré au 01/01/2024 + Appel avec une date de fin avant le début des contrats et avec le forçage d’activé
    When I send a contract from file "contratV6/createServicePrest2-6133" to version "V6"
    # Appel HTP
    When I get contrat PAUV5 for 1000611111111 '19590224' 1 '2023-07-15' '2023-07-18' 0000401166 HTP for issuingCompanyCode 000ER00955 and isForced true
    Then we found 2 contracts
