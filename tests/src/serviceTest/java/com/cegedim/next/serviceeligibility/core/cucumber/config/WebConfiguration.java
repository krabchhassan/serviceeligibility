...
public class WebConfiguration implements WebMvcConfigurer {
  ...
  public void configureJacksonMapper(final ObjectMapper objectMapper) {
    ...
    objectMapper.registerModule(builEmptyStringDeserializerModule());
  }
   ...
   * @return an instance of {@link SimpleModule}.
   */
  private SimpleModule builEmptyStringDeserializerModule() {
    final SimpleModule simpleModule = new SimpleModule();

    simpleModule.addDeserializer(String.class, new EmptyStringDeserializer());
